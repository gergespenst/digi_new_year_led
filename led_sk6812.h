...
#define __WS2812_H__
 ...
 #define LED_PIN_HIGH() LED_GPIO_PORT  |= LED_GPIO_PIN
 #define LED_PIN_LOW()  LED_GPIO_PORT&= ~LED_GPIO_PIN
#endif
...
void SendAllPixels();//‘ункци€ отправл€юща€ массив пискселей в физические пиксели
uint8_t SetPixelColor(uint8_t pixnum,uint8_t r,uint8_t g,uint8_t b, uint8_t white,uint16_t brightness);
